...
class ChoresControllerTest < ActionController::TestCase
  ...
  test "should create chore" do
    assert_difference('Chore.count') do
      post :create, chore: { every_x_days: @chore.every_x_days, last_done: @chore.last_done, name: @chore.name }
    end
  ...
  test "should update chore" do
    patch :update, id: @chore, chore: { every_x_days: @chore.every_x_days, last_done: @chore.last_done, name: @chore.name }
    assert_redirected_to chore_path(assigns(:chore))
  end
